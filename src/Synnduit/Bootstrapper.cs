...
namespace Synnduit
{
    ...
    {
        private static Lazy<BootstrapperDependencyContainer> container =
            new Lazy<BootstrapperDependencyContainer>(CreateContainer);
        ...
        private abstract class ExportRegistrationWrapper
        {
            ...
            protected bool IsAttributeApplied(Type type)
            {
                return
                    type
                    .GetCustomAttributes(this.AttributeType, false)
                    .Count() > 0;
            }
        }
