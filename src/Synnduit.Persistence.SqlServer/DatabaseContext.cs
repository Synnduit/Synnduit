...
namespace Synnduit.Persistence.SqlServer
{
    ...
    internal class DatabaseContext : DbContext
    {
        ...
        /// </summary>
        public virtual IDbSet<EntityMapping> EntityMappings { get; set; }
        ...
        /// </summary>
        public virtual IDbSet<ExternalSystem> ExternalSystems { get; set; }
        ...
        /// </summary>
        public virtual IDbSet<MappedEntityIdentifier> MappedEntityIdentifiers { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="MappingEntity" /> data set.
        /// </summary>
        public virtual IDbSet<MappingEntity> MappingEntities { get; set; }
        ...
        /// </summary>
        public virtual IDbSet<SharedIdentifierSourceSystem>
            ...
            params SqlParameter[] parameters)
        {
            ...
            this.Database.ExecuteSqlCommand(sql.ToString().Trim(), parameters);
        }
